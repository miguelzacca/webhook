        ...
        <div className="bg-neutral-900/50 backdrop-blur-md border border-neutral-800 rounded-2xl p-6 shadow-2xl relative overflow-hidden group">
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center h-64 text-neutral-500 space-y-4">
              ...
              <p className="text-xs text-neutral-600">Send a POST request to <code className="bg-neutral-800 px-1 py-0.5 rounded text-neutral-400">/api/webhook</code> or GET request to <code className="bg-neutral-800 px-1 py-0.5 rounded text-neutral-400">/api/webhook/g</code></p>
            </div>
          )}
        </div>
      </div>
